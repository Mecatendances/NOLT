...
export function ShopAdminLayout() {
  ...
  // Navigation spécifique à la boutique courante
  const navigation: NavItem[] = [
    ...
    {
      name: 'Commandes',
      path: `/shops/${id}/admin/orders`,
      icon: ClipboardList
    },
    {
      name: 'Produits',
      path: `/shops/${id}/admin/products`,
      icon: Package
    },
    {
      name: 'Utilisateurs',
      path: `/shops/${id}/admin/users`,
      icon: Users
    },
    {
      name: 'Campagnes',
      path: `/shops/${id}/admin/campaigns`,
      icon: Megaphone
    },
    {
      name: 'Personnalisation',
      path: `/shops/${id}/admin/branding`,
      icon: Palette
    },
    {
      name: 'Intégrations',
      path: `/shops/${id}/admin/integrations`,
      icon: Settings,
      action: () => navigate(`/shops/${id}/admin/integrations`)
    }
  ];
