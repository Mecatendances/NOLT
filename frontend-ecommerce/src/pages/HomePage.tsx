...
export function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative py-32 flex items-center justify-center overflow-hidden" style={{background: 'var(--brand-header-bg, #18181b)'}}>
        ...
        {/* Overlay */}
        <div className="absolute inset-0" style={{background: 'linear-gradient(135deg, var(--brand-secondary, #FFD600) 90%, #18181b 100%)', opacity: 0.9}} />
        
        <div className="relative text-center px-4 max-w-4xl mx-auto" style={{color: 'var(--brand-header-text, #fff)'}}>
          <h1 className="font-thunder text-7xl mb-6 tracking-tight italic uppercase">FC CHALON</h1>
          <p className="text-3xl font-thunder italic mb-8" style={{color: 'var(--brand-secondary, #FFD600)'}}>INDESTRUCTIBLES DEPUIS 1926</p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a 
              ...
              className="px-8 py-3 rounded-xl font-semibold flex items-center gap-2 transition-colors text-lg font-montserrat"
              style={{background: '#fff', color: 'var(--brand-secondary, #FFD600)'}}
            >
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full text-white mb-6" style={{background: 'var(--brand-primary, #0E214A)'}}>
                <Users className="h-8 w-8" />
              </div>
              <h3 className="font-thunder text-2xl mb-4 italic uppercase" style={{color: 'var(--brand-primary, #222)'}}>Nos Équipes</h3>
              <p className="text-gray-600 font-montserrat">
              ...
              <button className="mt-6 transition-colors font-montserrat flex items-center gap-1 mx-auto" style={{color: 'var(--brand-primary, #0E214A)'}}>
                Voir nos équipes
                <ArrowRight className="h-4 w-4" />
              </button>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-thunder text-2xl mb-4 italic uppercase" style={{color: 'var(--brand-primary, #222)'}}>Notre Boutique</h3>
              <p className="text-gray-600 font-montserrat">
              ...
              <Link 
                to="/public/shops"
                className="mt-6 transition-colors font-montserrat flex items-center gap-1 mx-auto"
      ...
      {/* CTA Section */}
      <div className="py-16" style={{background: 'var(--brand-primary, #0E214A)'}}>
        <div className="container mx-auto max-w-4xl px-4 text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-6 py-3 bg-white rounded-lg font-medium hover:bg-gray-100 transition-colors font-montserrat" style={{color: 'var(--brand-primary, #0E214A)'}}>
              Devenir membre
            </button>
            <Link
              to="/login" 
              className="px-6 py-3 rounded-lg font-medium transition-colors font-montserrat"
              style={{background: 'var(--brand-secondary, #FFD600)', color: 'var(--brand-primary, #222)'}}
            >
              Espace membres
            </Link>
      ...
      {/* Footer */}
      <footer className="py-16" style={{background: 'var(--brand-footer-bg, #18181b)', color: 'var(--brand-footer-text, #fff)'}}>
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              <h3 className="font-thunder text-2xl mb-6 italic uppercase" style={{color: 'var(--brand-secondary, #FFD600)'}}>FC CHALON</h3>
              ...
              <div className="flex gap-4 mt-6">
                <a href="#" className="hover:opacity-80" style={{color: 'var(--brand-footer-text, #fff)'}}>
